...
const AddressForm = ({ checkoutToken, next }) => {
    ...
    const fetchSubdivisions = async (countryCode) => {
        ...
        setShippingSubdivision(Object.keys(subdivisions)[11]);
    }
    ...
    return (
        <>
            ...
            <FormProvider {...methods}>
                <form onSubmit={methods.handleSubmit(async (data, e) => {
                    const allData = { ...data, shippingCountry, shippingSubdivision, shippingOption };
                    // console.log("onsubmit of address", allData);
                    next(allData);                    
                })}>
